...
static int __init mychardev_init(void)
{
    ...
    err = alloc_chrdev_region(&dev, 0, MAX_DEV, "spi-dev");

    dev_major = MAJOR(dev);

    mychardev_class = class_create(THIS_MODULE, "spi-dev");
    ...
    for (i = 0; i < MAX_DEV; i++) {
        ...
        device_create(mychardev_class, NULL, MKDEV(dev_major, i), NULL, "spi-dev-%d", i);
    }
